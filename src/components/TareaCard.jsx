import { DialogDemo } from "@/demo/DialogAsignarUser";
...
const TareaCard = ({ titulo, descripcion, fecha, prioridad, estado, tarea }) => {
  ...
  return (
    <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-4 space-y-6">
      <div className="mb-2">
      ...
      <div className="mb-3">
        ...
        <span className="inline-flex m-4 items-center px-3 py-2 ml-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
          {estado}
        </span>
      </div>
      <DialogDemo name={titulo} />
