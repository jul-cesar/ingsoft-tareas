...
function ProfileForm({ className, namet, tareaInfo }) {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-start flex-wrap gap-2 m-4">
          ...
          listaComentarios.map((comentario) => (
            <div class="flex">
              <img
                ...
                alt="Jese image"
              />
              <div class="flex flex-col max-h-[100px] w-[320px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
                ...
                <p class="text-sm font-normal py-2.5 text-gray-900 dark:text-white line-clamp-3 text-ellipsis text-wrap ">
