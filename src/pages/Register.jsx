...
const Register = () => {
  ...
  return (
    <div className="auth flex flex-col  items-center justify-center w-screen h-screen">
      ...
      >
        ...
        <div className="flex flex-col gap-2 items-center justify-center">
          <h2 class="mb-4 text-2xl font-bold leading-none tracking-tight text-gray-900 md:text-2xl lg:text-3xl">Crea tu cuenta 👋 </h2>
          <button type="button"
            onClick={() => {
              googleAuth();
            }}
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div className="flex flex-col justify-center items-center m-4 gap-2">
              <Link className="self-start font-medium text-gray-900 underline" to={"/login"}>
                Inicia sesion
              </Link>
